...
<body>
<?php $this->beginBody() ?>
<?= (new \common\event\Language)->translation(\lulutrip\widgets\TopWidgets::widget());?>
<?= \lulutrip\widgets\TrackCode::widget();?>
<?= (new \common\event\Language)->translation($content) ?>
<?= (new \common\event\Language)->translation(\lulutrip\widgets\FooterWidgets::widget());?>
<?= (new \common\event\Language)->translation(\lulutrip\widgets\SidebarWidgets::widget());?>
<?= (new \common\event\Language)->translation(\lulutrip\widgets\CallmeNowWidgets::widget());?>
<?php $this->endBody() ?>
</body>
</html>
<?php $this->endPage() ?>
